...
import com.bgsoftware.wildchests.nms.v1_18_R2.NMSInventory;
import com.bgsoftware.wildchests.nms.v1_18_R2.mappings.net.minecraft.core.BlockPosition;
import com.bgsoftware.wildchests.nms.v1_18_R2.mappings.net.minecraft.world.entity.Entity;
import com.bgsoftware.wildchests.nms.v1_18_R2.mappings.net.minecraft.world.inventory.Container;
import com.bgsoftware.wildchests.nms.v1_18_R2.mappings.net.minecraft.world.level.World;
import com.bgsoftware.wildchests.nms.v1_18_R2.mappings.net.minecraft.world.level.block.entity.TileEntity;
...
public class TileEntityWildChest extends TileEntityChest implements IWorldInventory, TileEntityContainer,
    ...
    @Remap(classPath = "net.minecraft.world.level.block.Blocks", name = "TRAPPED_CHEST", type = Remap.Type.FIELD, remappedName = "fE")
    private static final Block TRAPPED_CHEST_BLOCK = Blocks.fE;
    @Remap(classPath = "net.minecraft.world.level.block.Blocks", name = "CHEST", type = Remap.Type.FIELD, remappedName = "bX")
    private static final Block CHEST_BLOCK = Blocks.bX;
    @Remap(classPath = "net.minecraft.sounds.SoundEvents", name = "CHEST_CLOSE", type = Remap.Type.FIELD, remappedName = "cO")
    private static final SoundEffect CHEST_CLOSE_SOUND = SoundEffects.cO;
    @Remap(classPath = "net.minecraft.sounds.SoundEvents", name = "CHEST_OPEN", type = Remap.Type.FIELD, remappedName = "cQ")
    private static final SoundEffect CHEST_OPEN_SOUND = SoundEffects.cQ;
    ...
    public NonNullList<ItemStack> getContents() {
        ...
        NonNullList<ItemStack> nonNullList = NonNullList.a(contents.length,
                ItemStack.b);
    ...
    @Remap(classPath = "net.minecraft.world.level.block.entity.ChestBlockEntity",
            ...
            remappedName = "b_")
    @Override
    public final void b_(EntityHuman nmsEntityHuman) {
        CraftHumanEntity craftHumanEntity = nmsEntityHuman.getBukkitEntity();
