...
import net.minecraft.server.v1_16_R2.IWorldInventory;
...
public final class NMSInventory_v1_16_R2 implements NMSInventory {
    ...
    private static class TileEntityWildChest extends TileEntityChest implements IWorldInventory, TileEntityContainer, ITickable {
        ...
        public Container createContainer(int id, PlayerInventory playerinventory) {
            Container container = NMSInventory_v1_16_R2.createContainer(id, playerinventory, (com.bgsoftware.wildchests.objects.inventory.CraftWildInventory) chest.getPage(0));
