...
import com.bgsoftware.wildchests.nms.v1_8_R3.utils.NbtUtils;
...
public final class NMSAdapterImpl implements NMSAdapter {
    ...
    public InventoryHolder[] deserialze(String serialized) {
        ...
        try {
            NBTTagCompound tagCompound = NbtUtils.read(new DataInputStream(inputStream));
    ...
    public org.bukkit.inventory.ItemStack deserialzeItem(String serialized) {
        ...
        try {
            NBTTagCompound nbtTagCompoundRoot = NbtUtils.read(new DataInputStream(inputStream));
    ...
    private InventoryHolder deserialize(NBTTagCompound tagCompound) {
        ...
        for (int i = 0; i < itemsList.size(); i++) {
            ...
            inventory.setItem(nbtTagCompound.getByte("Slot"), CraftItemStack.asCraftMirror(ItemStack.createStack(nbtTagCompound)));
        }
