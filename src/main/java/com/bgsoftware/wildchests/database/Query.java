...
public enum Query {
    ...
    REGULAR_CHEST_INSERT("REPLACE INTO chests VALUES(?, ?, ?, ?);"),
    ...
    LINKED_CHEST_INSERT("REPLACE INTO linked_chests VALUES(?, ?, ?, ?, ?);"),
    ...
    STORAGE_UNIT_INSERT("REPLACE INTO storage_units VALUES(?, ?, ?, ?, ?, ?);"),
